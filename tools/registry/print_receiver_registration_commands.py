...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Print ckb-cli tx commands for receiver registration"
    )
...
def main() -> None:
    ...
    print()
    print(
        "4. Derive the immutable Registry V2 Type ID from that first input and apply the type script:"
    )
    print(
