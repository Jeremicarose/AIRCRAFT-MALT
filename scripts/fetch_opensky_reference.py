...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Fetch OpenSky reference data for MLAT benchmarking")
...
def main() -> int:
    ...
    print(f"Fetched {len(states)} OpenSky state rows and exported {exported} benchmark reference records to {output_path}")
    return 0
