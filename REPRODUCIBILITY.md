...
The generator checks the exact Node.js version in `.nvmrc` before starting its
long-running checks. Run `nvm use` if the preflight reports a different active
version.
