...
| MLAT reference software | PARTIAL | Full 199-test repository Python suite passes; strict live gates and evidence verifier exist | Physical synchronized receiver run and independent reference data are absent |
