...
| Cross-language SDK | Protocol vectors, transaction preparation, and cursor-exhaustive discovery/history agree | PASS | 72 TypeScript SDK tests and 171 shared runtime assertions passed |
